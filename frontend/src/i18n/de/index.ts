export default {
  ...
  ArtivactPeripheralsConfigurationEditor: {
    ...
    creator: {
      ...
      description: 'Zum erstellen von 3D-Modellen wird Photogrammetrie-Software verwendet. Momentan werden "Metashape", "Meshroom" und "RealityScan" unterstützt.',
      label: 'Photogrammetrie-Software',
      meshroom: 'Meshroom Exe-Datei',
      metashape: 'Metashape Exe-Datei',
      RealityScan: 'RealityScan Exe-Datei. "#headless#12345" anhängen für Hintergrundverarbeitung und Face-Limit von 12345.'
    },
    editor: {
