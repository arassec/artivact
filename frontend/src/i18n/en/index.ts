export default {
  ...
  EditablePage: {
    ...
    tour: {
      ...
      menuBarDescription: 'This is artivact\'s main menu bar where you can access different sections of the application.',
      menuWelcomeTitle: 'Menu Entry',
      menuWelcomeDescription: 'This is a menu entry. It can be customized by right-clicking on it.<br/><br/>The welcome page shown can be customized as well to fit your needs.',
      addMenuTitle: 'Add Menu Entry',
      addMenuDescription: 'With this button you can add your own menu entries to the menu bar.',
      itemSettingsTitle: 'Manage Items',
      itemSettingsDescription: 'This menu lets you manage your collection\'s items.<br/><br/>You can create new items, import them or modify existing ones in batch.',
      systemSettingsTitle: 'System Settings',
      systemSettingsDescription: 'This menu configures the application.<br/><br/>You can e.g. define properties of your collection items, customize Artivact\'s look or setup peripherals for 3D scanning.',
      editPageTitle: 'Edit Page',
      editPageDescription: 'You can customize every page by clicking on its edit button.<br/><br/>This enables the edit mode, which allows you to add, remove or modify widgets on the page.',
      setupScanningTitle: 'Setup 3D Scanning',
      setupScanningDescription: 'If you intent to 3D scan your collection items, you should setup peripherals for scanning next.',
      scanItemTitle: 'Scan Item',
      scanItemDescription: 'Afterwards, you can start scanning your first item.',
      searchResultsTitle: 'Collection Items',
      searchResultsDescription: 'Your new collection items will appear here after scanning.<br/><br/>Customize the search results by editing the page and this widget.',
      documentationTitle: 'Documentation',
      documentationDescription: 'You can find more detailed information in Artivact\'s documentation.<br/><br/>Have fun managing your collection! :-)',
    }
  },
