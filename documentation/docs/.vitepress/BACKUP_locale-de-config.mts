                    ...
                    '/de/tutorials/': [
                        {
                            ...
                            items: [
                                ...
                                {
                                    text: 'Artivact Drehteller',
                                    link: '/de/tutorials/artivact-as-scanner/artivact-turntable'
                                },
                                {
                                    text: 'Fotos Freistellen',
                                    link: '/de/tutorials/artivact-as-scanner/background-removal'
                                },
                                {text: '3D-Modell Erzeugung', link: '/de/tutorials/artivact-as-scanner/model-creation'},
                                {
                                    text: '3D-Modell Bearbeitung',
                                    link: '/de/tutorials/artivact-as-scanner/model-editing'
                                },
                            ]
                        }
                    ],
