...
Die Übersetzung basiert auf dem **Übersetzungs-Prompt**. Das Prompt-Template kann
...
Die Audiogenerierung basiert auf der konfigurierten **TTS-Stimme**. Die erzeugten
