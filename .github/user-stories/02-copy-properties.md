...
- **File:** Locate the component rendering the favorites list.
...
- Use translation keys instead of texts in notifications and translate to English and German in the respective ts files. 